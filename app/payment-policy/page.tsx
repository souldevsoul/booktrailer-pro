        ...
        <Container maxWidth="xl">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-violet-100 rounded-2xl shadow-cinema border border-slate-200 mb-8">
              <RiSecurePaymentLine className="w-6 h-6 text-violet-600" />
              <span className="text-sm font-semibold tracking-wide text-violet-600">Payment Policy</span>
            </div>
        ...
        <Container maxWidth="xl">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-white rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-4 text-violet-900">Credit & Debit Cards</h3>
                ...
                <div className="p-6 bg-violet-50 rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">Payment Processor</h3>
                  <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-white rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">Subscription Billing</h3>
                ...
                <div className="p-6 bg-violet-50 rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">Currency & Pricing</h3>
                ...
                <div className="p-6 bg-gradient-dark text-white rounded-2xl shadow-cinema border border-slate-700">
                  <h3 className="text-lg font-semibold mb-3 text-violet-300">No Minimum or Maximum Transaction Amounts</h3>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-white rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">PCI DSS Compliance</h3>
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-2">
                      <span className="text-violet-600 font-semibold">•</span>
                ...
                <div className="p-6 bg-violet-50 rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">What We Store</h3>
                  <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-white rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">Automatic Retry</h3>
                  <p className="text-gray-700 leading-relaxed mb-3">
                ...
                <div className="p-6 bg-violet-50 rounded-2xl shadow-cinema border border-slate-200">
                  <h3 className="text-lg font-semibold mb-3 text-violet-900">Account Suspension</h3>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div className="p-6 bg-gradient-dark text-white rounded-2xl shadow-cinema border border-slate-700">
                  <h3 className="text-lg font-semibold mb-3 text-violet-300">Email Notifications</h3>
                  <p className="leading-relaxed">
            ...
            {/* Contact */}
            <div>
              <div className="p-8 bg-violet-50 rounded-2xl shadow-cinema border border-slate-200 text-center">
                ...
                <div className="space-y-2">
                  <p>
                    ...
                    <a href="mailto:billing@booktrailer.pro" className="underline hover:no-underline text-violet-600">
