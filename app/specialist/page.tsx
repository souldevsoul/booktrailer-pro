  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50/30 to-gray-50/30 flex items-center justify-center p-6">
      <div className="text-center space-y-6 max-w-2xl">
        ...
        <h1 className="text-4xl font-display font-bold text-slate-900">Specialist Dashboard Coming Soon</h1>
        <p className="text-xl text-slate-600 leading-relaxed">Specialist tools coming soon!</p>
